...
// 1. Tách dữ liệu ra ngoài và sử dụng Cloudinary Public ID
const TOURS_DATA = (t: any) => [
    {
        ...
        location: "Quang Ninh",
        rating: 4.9,
        image: "halong_luxury_v1", // Cloudinary ID
        category: "Luxury"
    },
    {
        id: 2,
        ...
        location: "Sapa",
        rating: 4.8,
        image: "sapa_trekking_v2", // Cloudinary ID
        category: "Adventure"
    },
    {
        id: 3,
        ...
        location: "Hoi An",
        rating: 4.9,
        image: "hoian_culture_v3", // Cloudinary ID
        category: "Cultural"
    },
];
...
export const FeaturedTours = memo(() => {
    ...
    return (
        <section 
            ...
            style={{ contain: 'content' }} // 2. Cô lập vùng render để tránh Reflow toàn trang
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {tours.map((tour, index) => (
                        <motion.div
                            ...
                            className="group transform-gpu will-change-transform" // 3. Tối ưu GPU cho hiệu ứng Card
                        >
