...
export const HeroSection = memo(() => {
  ...
  return (
    <section 
      ...
      style={{ contain: 'layout' }} // 1. Cô lập hoàn toàn section để render thần tốc
    >
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
          fetchPriority="high"
          loading="eager" // 2. Ép trình duyệt giải nén ảnh ngay lập tức
          className="object-cover scale-105" // Scale nhẹ để che các cạnh khi animation
          sizes="100vw"
          quality={85} // Tăng nhẹ quality cho Hero vì đây là bộ mặt thương hiệu
        />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* 3. Tối ưu Animation: Chỉ dùng motion cho các phần tử nhỏ, H1 nên xuất hiện gần như tức thì */}
          <motion.div
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-9xl text-sand-light mb-6 leading-[0.9] tracking-tighter">
            {/* 4. Text mồi: Dùng CSS thuần để chữ Random hiện ra ngay trước khi JS load xong */}
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center transform-gpu">
            ...
            {/* Thêm một nút thứ 2 để cân bằng layout và tăng tương tác */}
      ...
      {/* 5. Hiệu ứng mượt mà khi cuộn: Gradient che đáy */}
