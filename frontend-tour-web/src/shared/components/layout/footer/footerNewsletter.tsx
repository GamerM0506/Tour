...
export const FooterNewsletter = ({ t }: FooterNewsletterProps) => {
    return (
        <div>
            <div className="mb-6">
            ...
            <form className="relative" onSubmit={(e) => e.preventDefault()}>
                <div className="relative">
                    <input
                        ...
                        className="w-full bg-forest/30 backdrop-blur-sm border border-sand/10 text-sand-light placeholder:text-sand/40 px-5 py-4 rounded-lg outline-none focus:border-terracotta/50 focus:ring-1 focus:ring-terracotta/30 transition-all duration-300 text-sm pr-14"
                        required
                    />
                    <button
                        type="submit"
                        className="absolute right-2 top-1/2 -translate-y-1/2 bg-linear-to-r from-terracotta to-clay text-sand-light p-2 rounded-md hover:shadow-[0_0_20px_rgba(196,106,74,0.4)] transition-all duration-300 hover:scale-105"
